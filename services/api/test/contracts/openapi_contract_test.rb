...
class OpenapiContractTest < ActiveSupport::TestCase
  ...
  test "the checked-in contract describes the current API and health endpoint" do
    ...
    assert_equal "1.6.0", contract.dig("info", "version")
    expected_paths = %w[
      /api/v1/health
      ...
      /api/v1/households/{householdId}/shopping-list/complete
      /api/v1/households/{householdId}/shopping-list/entries
      /api/v1/households/{householdId}/shopping-list/entries/{shoppingEntryId}
